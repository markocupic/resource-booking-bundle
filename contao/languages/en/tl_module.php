...
// Fields
$GLOBALS['TL_LANG']['tl_module']['resourceBooking_resourceTypes'] = ['Resourcen-Types', 'Select one ore more resource types.'];
$GLOBALS['TL_LANG']['tl_module']['resourceBooking_hideDays'] = ['Allow bookings for limited weekdays only', 'Allow booking for limited weekdays only.'];
$GLOBALS['TL_LANG']['tl_module']['resourceBooking_hideDaysSelection'] = ['Select weekdays.', 'Select weekdays where booking will be possible.'];
...
$GLOBALS['TL_LANG']['tl_module']['resourceBooking_appConfig'] = ['App-Configuration', 'Create your custom app configuration in "app/config.yml".'];
